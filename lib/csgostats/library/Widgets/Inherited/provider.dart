...
class NotifierProvidere<Model extends ChangeNotifier> extends StatefulWidget {
  final Widget child;
  final bool isManagingModel;
  final Model Function() create;
  const NotifierProvidere({
    Key? key,
  ...
  @override
  _NotifierProvidereState<Model> createState() =>
      _NotifierProvidereState<Model>();
...
class _NotifierProvidereState<Model extends ChangeNotifier>
    extends State<NotifierProvidere<Model>> {
